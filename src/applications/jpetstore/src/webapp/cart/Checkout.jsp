        ...
        <tr>
          <td bgcolor="#FFFF88">
            <html:link page="/shop/viewCart.shtml">
              <b><font color="BLACK" size="2">&lt;&lt; Shopping Cart</font></b>
            </html:link>
          </td>
        </tr>
      </table>
...
<logic:iterate id="cartItem" name="cart" property="cartItems">
        <tr bgcolor="#FFFF88">
          <td>
            <b>
              <html:link paramId="itemId" paramName="cartItem"
                         paramProperty="item.itemId"
                         page="/shop/viewItem.shtml">
                <bean:write name="cartItem" property="item.itemId" />
              </html:link>
            </b>
          </td>
          ...
          <td align="center">
            <bean:write name="cartItem" property="inStock" />
          </td>
          <td align="center">
            <bean:write name="cartItem" property="quantity" />
          </td>
          <td align="right">
            <bean:write name="cartItem" property="item.listPrice"
                        format="$#,##0.00" />
          </td>
          <td align="right">
            <bean:write name="cartItem" property="total" format="$#,##0.00" />
          </td>
        </tr>
</logic:iterate>
        ...
        <tr bgcolor="#FFFF88">
          <td colspan="7" align="right">
            <b>
              Sub Total: <bean:write name="cart" property="subTotal"
                                     format="$#,##0.00" />
            </b>
            <br />
          </td>
...
<logic:notEqual name="cart" property="cartItemList.firstPage" value="true" >
        <html:link href="switchCartPage.shtml?pageDirection=previous">
          <html:img src="../images/button_prev.gif" border="0"/>
        </html:link>
</logic:notEqual>

<logic:notEqual name="cart" property="cartItemList.lastPage" value="true" >
        <html:link href="switchCartPage.shtml?pageDirection=next">
      ...
      <center>
        <html:link page="/shop/newOrderForm.shtml">
